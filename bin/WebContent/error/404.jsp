...
isErrorPage="true" trimDirectiveWhitespaces="true"%>
<!DOCTYPE html>
<html>
<head>
	<link rel="stylesheet" href="${APP_PATH}/error/css/style.css">
	<link href="${APP_PATH}/error/css/style2.css" rel='stylesheet' type='text/css'>
